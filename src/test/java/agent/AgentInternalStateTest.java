...
public class AgentInternalStateTest {
    ...
    public void testUpdateEmotionalState() {
        ...
        // Check intensities
        assertEquals(1d, ais.get(0).intensity, 10E-15);
        assertEquals(2d, ais.get(1).intensity, 10E-15);
    ...
    public void testUpdateEmotionalStateDuplicate() {
        ...
        // Check intensity
        assertEquals(3d, ais.get(0).intensity, 10E-15);
    ...
    public void testGetEmotionalStateGain() {
        ...
        assertEquals(.5, test.get(0).intensity, 10E-15);
