...
public class Goal {
    ...
    public Goal(String name, double utility, boolean isMaintenanceGoal) {
        ...
        this.likelihood = 0.5; // The likelihood is unknown at the start so it
                               // starts in the middle
        // between disconfirmed (0) and confirmed (1)

        // There are maintenance and achievement goals.
        // When an achievement goal is reached (or not), this is definite (e.g.,
        // to a the promotion or
        // not).
        // A maintenance goal can become true/false indefinitely (e.g., to be
        // well-fed)
    ...
    public boolean equals(Object obj) {
        ...
        if (obj instanceof Goal) {
            ...
            return this.name.equals(other.name) && Double.compare(this.utility, other.utility) == 0 && Double.compare(this.likelihood, other.likelihood) == 0
